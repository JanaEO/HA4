...
page = option_menu(
    menu_title=None,
    options=["Home","Dataset", "Visualizations", "Regions","Model"],
...
#  user input
    ...
    sex = st.selectbox("Select your Sex", df['sex'].unique())
    smoker = st.selectbox("Are you a smoker?", df['smoker'].unique())
    age = st.slider("What is your age?", 18, 80)
...
# convert user inputs for the model
